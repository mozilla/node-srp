...
function getu(params, A, B) {
  assertIsBignum(A);
  assertIsBignum(B);
  var u = getuBuffer(params, padToN(A, params), padToN(B, params));
  return bignum.fromBuffer(u);
};
...
module.exports = {
  getx: function (params, salt, I, P) {
    return padToH(getx(params, salt, I, P), params);
  },
  getv: function (params, salt, I, P) {
    return padToN(getv(params, salt, I, P), params);
  },
  genKey: genKey,
  getB: function (params, v, b) {
    assertIsNBuffer(v, params, "v");
    return padToN(getB(params, bignum.fromBuffer(v), bignum.fromBuffer(b)), params);
  },
  getA: function (params, a) {
    return padToN(getA(params, bignum.fromBuffer(a)), params);
  },
  client_getS: function (params, salt, I, P, a, B) {
    assertIsNBuffer(B, params, "B");
    return padToN(client_getS(params, salt, I, P,
                              bignum.fromBuffer(a), bignum.fromBuffer(B)),
                  params);
  },
  server_getS: function (params, v, A, b) {
    assertIsNBuffer(v, params, "v");
    assertIsNBuffer(A, params, "A");
    return padToN(server_getS(params, bignum.fromBuffer(v),
                              bignum.fromBuffer(A), bignum.fromBuffer(b)),
                  params);
  },
  getu: getuBuffer,
