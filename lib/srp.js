...
/*
 * compute the intermediate value x
 *
 *      x = SHA1(s | SHA1(I | ":" | P))
 */
...
/*
 * The premaster secret as calculated by the client
 *
 * params:
 *         s (bigint)       salt (read from server)
 ...
 * returns: bigint
 */
var clientPremasterSecret = exports.clientPremasterSecret = function clientPremasterSecret(s, I, P, N, g, a, B, alg) {
  var A = getA(g, a, N);
...
/*
 * The premastersecret as calculated by the server
 *
 * params:
 ...
 * returns: bigint
 */
var serverPremasterSecret = exports.serverPremasterSecret = function serverPremasterSecret(s, v, N, g, A, b, alg) {
  var k = getk(N, g, alg);
